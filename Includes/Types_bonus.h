...
/*   Updated: 2024/11/15 14:55:00 by abadouab         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	bool			is_door;		// Map Door Detected
...
typedef struct s_ray
{
	...
	bool			is_door;		// Check is door
	int				index;			// Index number of this ray
	int				progress;			// Angle of the ray
